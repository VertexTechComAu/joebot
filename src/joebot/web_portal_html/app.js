	...
	methods: {
		...
		open_vnc (item) {
			if( item.novnc_websocket_info ){
				window.open(`http://novnc.com/noVNC/vnc.html?host=${window.location.hostname}&port=${item.novnc_websocket_info.port_tunnel.server_port}&encrypt=1&autoconnect=1`);
			}
		},
		resetModal () {
